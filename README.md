...
* Use the Host Name [http://ec2-35-178-90-82.eu-west-2.compute.amazonaws.com]( amazonaws.com) <b style='color:red'>(not just the public IP)</b> in the browser to launch the app.
